...
val ArrowForward: ImageVector
    get() {
        if (_VscodeCodiconsArrowCircleRight != null) return _VscodeCodiconsArrowCircleRight!!

        _VscodeCodiconsArrowCircleRight = ImageVector.Builder(
        ...
        return _VscodeCodiconsArrowCircleRight!!
    }
